/**
 * interact.js v0.0.0+sha.b6f2c43
 *
...
_$pointerExtend_55.default = pointerExtend;
...
var __is_18 = ___interopRequireWildcard_18(_$is_52);

var ___events_18 = ___interopRequireDefault_18(_$events_46);
...
function checkAndPreventDefault(interactable, scope, event) {
  ...
  if (__is_18.element(event.target) && (0, _$domUtils_45.matchesSelector)(event.target, 'input,select,textarea,[contenteditable=true],[contenteditable=true] *')) {
    return;
  }
...
function getModifierList(interaction, registeredModifiers) {
  ...
  return ['snap', 'snapSize', 'snapEdges', 'restrict', 'restrictEdges', 'restrictSize', 'restrictCircle'].map(function (type) {
...
var ___raf_21 = ___interopRequireDefault_21(_$raf_57);
...
var _interactionFinder = ___interopRequireDefault_19(_$interactionFinder_51);

var ___browser_19 = ___interopRequireDefault_19(_$browser_42);

var ___domObjects_19 = ___interopRequireDefault_19(_$domObjects_44);

var ___pointerUtils_19 = ___interopRequireDefault_19(_$pointerUtils_56);

var ___Signals_19 = ___interopRequireDefault_19(_$Signals_40);
...
var __utils_20 = ___interopRequireWildcard_20(_$utils_50);
...
var ___browser_23 = ___interopRequireDefault_23(_$browser_42);

var ___events_23 = ___interopRequireDefault_23(_$events_46);

var __utils_23 = ___interopRequireWildcard_23(_$utils_50);
...
Object.defineProperty(_$circle_27, "__esModule", {
  value: true
});
_$circle_27.default = void 0;

var __is_27 = ___interopRequireWildcard_27(_$is_52);

var ___rect_27 = ___interopRequireDefault_27(_$rect_58);
...
function set(_ref2) {
  ...
  var rect = restriction; // console.log('\nrect:', rect);
  // console.log('x init:', coords.x, ' y init:', coords.y);
  // center of circle: (X, Y)

  var X = rect.width / 2 + rect.left;
  var Y = rect.height / 2 + rect.top; // console.log('X:', X, ' Y:', Y);

  var R = Math.min(rect.width / 2, rect.height / 2);
  var r = Math.sqrt(Math.pow(Math.abs(coords.x - X), 2) + Math.pow(Math.abs(coords.y - Y), 2)); // console.log('R:', R, ' r:', r);
...
_$circle_27.default = ___default_27;
...
function __set_29(_ref2) {
  ...
  var options = state.options,
      offset = state.offset;
  var restriction = __getRestrictionRect_29(options.restriction, interaction, coords);
...
function __getRestrictionRect_29(value, interaction, coords) {
...
var ___default_29 = __restrict_29;
...
_$modifiers_26.restrictSize = _$modifiers_26.restrictEdges = _$modifiers_26.restrictCircle = _$modifiers_26.restrict = _$modifiers_26.snapEdges = _$modifiers_26.snapSize = _$modifiers_26.snap = void 0;

var ___base_26 = ___interopRequireDefault_26(_$base_25);

var ___pointer_26 = ___interopRequireDefault_26(_$pointer_32);

var ___size_26 = ___interopRequireDefault_26(_$size_33);

var ___edges_26 = ___interopRequireDefault_26(_$edges_31);

var _pointer2 = ___interopRequireDefault_26(_$pointer_29);

var _circle = ___interopRequireDefault_26(_$circle_27);

var _edges2 = ___interopRequireDefault_26(_$edges_28);

var _size2 = ___interopRequireDefault_26(_$size_30);
...
var restrictCircle = __makeModifier_26(_circle.default, 'restrictCircle');
_$modifiers_26.restrictCircle = restrictCircle;
...
function reflow(interactable, action, scope) {
  var elements = _$utils_50.is.string(interactable.target) ? _$utils_50.arr.from(interactable._context.querySelectorAll(interactable.target)) : [interactable.target];
...
var __pointerEvents_22 = ___interopRequireWildcard_22(_$pointerEvents_37);
...
var _reflow = ___interopRequireDefault_22(_$reflow_39);
...
_interact.default.version = __init_22.version = "1.3.5";
...
var snappers = ___interopRequireWildcard_24(_$snappers_60);

var ___extend_24 = ___interopRequireDefault_24(_$extend_47);
